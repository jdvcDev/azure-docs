...
WAF on Front Door is a global and centralized solution. It's deployed on Azure network edge locations around the globe. WAF enabled web applications to inspect every incoming request delivered by Front Door at the network edge. 
